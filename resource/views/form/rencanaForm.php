    ...
    if (isset ($_POST["submit"])){
       if( tambah($_POST) > 0){
           ...
           <script> 
                ...
                document.location.href = 'rencanaForm.php'
            </script>
                   ...
                   <div class="main-container">
                        ...
                        <form class="form-plan" action="" method="post">
                                    ...
                                    <div class="field-input">
                                        <input class="input" type="text" name="n-target" id="n-target" placeholder="mis. Dana darurat" required>
                                    </div>
                                    <label for="j-target">Nominal target</label><br>
                                    <div class="field-input">
                                        <input class="input" type="text" name="j-target" id="j-target" placeholder="mis. 11000000" required>
                                    </div>
                                    <label for="n-skrg">Nominal sekarang</label><br>
                                    <div class="field-input">
                                        <input class="input" type="text" name="n-skrg" id="n-skrg" placeholder="mis. 2000000" required>
                                    </div>
                                    <label for="t-target">Tenggat waktu</label><br>
                                    <div class="field-input">
                                        <input class="input" type="date" name="t-target"  id="t-target" placeholder="mis. 01-03-2021" required>
                                    </div>
